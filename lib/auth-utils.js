...
export async function supabaseFetch(path, options = {}) {
  ...
  // Same fallback chain the webhook uses — prod only has SERVICE_ROLE_KEY set,
  // so reading SUPABASE_KEY alone returned undefined and silently broke every
  // admin data query (e.g. the BFK dashboard showing 0 entries).

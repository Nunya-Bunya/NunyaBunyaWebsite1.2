...
export async function sendEmailNotification(to, subject, html, from = null) {
  ...
  // If caller passed a full "Name <email>" string, use it verbatim; else wrap with the default label.
  const FROM_HEADER = FROM_EMAIL.includes('<') ? FROM_EMAIL : `NB Alerts <${FROM_EMAIL}>`;
